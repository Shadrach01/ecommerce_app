  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () =>
            _showAnswerBottomSheet(context, title, isDark),
      ),
    );
  }
  ...
  String _getAnswer(String question) {
    final answers = {
      'How to track my order?':
          ...
          'You can also click on the tracking number in your order confirmation email to track your package direcly.',
      'How to return an item?':
          ...
          'Returns must be intiated within 30 days of delivery. Once we receive the item, your refund will be processed within 5-7 business days.',
    };

    return answers[question] ??
        'Informationnot available. Please contact support for assistance';
  }
}
